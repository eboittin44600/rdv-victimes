      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          {loading || !profil
            ...
            : <span className="text-sm font-medium text-gray-900">Bonjour Me {profil.prenom} {profil.nom}</span>
          }
        </div>
        {profil && (
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex gap-3 mb-3">
            ...
            <div className="flex items-center gap-1.5 text-xs text-gray-500">
              <div className="w-3 h-3 rounded border bg-blue-100 border-blue-300" />Reservé
            </div>
          </div>
          ...
          {showAjout && (
            <div className="mt-4 bg-white border border-gray-200 rounded-xl p-5">
              <h3 className="text-sm font-medium text-gray-900 mb-1">Nouvelle plage de disponibilite</h3>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <label htmlFor="recurrent" className="text-xs text-gray-600">Recurrent chaque semaine jusqu'au</label>
                {ajoutForm.recurrent && (
              ...
              <div className="flex gap-2">
                <button onClick={ajouterCreneau} disabled={ajoutLoading}
                  ...
                  {ajoutLoading ? 'Creation...' : 'Créer les créneaux'}
                </button>
